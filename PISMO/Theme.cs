...
namespace PISMO
{
    ...
    public static class Theme
    {
        ...
        private static Dictionary<int, Color> BuildMap()
        {
            ...
            Add(48, 51, 58, 224, 226, 230);   // пузырь сообщения (ЛС/сервер) — был не в карте (тёмный на светлой теме)
            Add(47, 68, 55, 214, 232, 220);   // свой/упоминание — зеленоватый пузырь → светло-зелёный

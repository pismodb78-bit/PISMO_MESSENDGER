...
namespace PISMO
{
    ...
    {
        // WS_EX_COMPOSITED: композиция всего окна вместе с дочерними контролами —
        // единственный надёжный способ убрать смаз/двоение пузырей сообщений при
        // прокрутке (DoubleBuffered буферизует только фон самой панели, не дочерние
        // окна; композиция на отдельных панелях давала светлые швы на стыках).
